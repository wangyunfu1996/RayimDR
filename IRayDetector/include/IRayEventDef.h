...
#define Evt_TemperatureWarning	2011 // Temperature is not ideal
...
#define Evt_Idc_ControlRequest	2018 // Notify user need request IDC control again
#define Evt_Idc_RequestData	2019 // Return IDC specified data while invoking Cmd_IDC_Request
...
#define Evt_Idc_XRayCutOffRequest	2033 // Notify user need cut off X-Ray immediately
#define Evt_LicenseExpireWarnning	2034 // Each time a connection is established, the user is notified that the license is about to expire, starting from the last week before the expiration.
#define Evt_LicenseExpired	2035 // After the License expires, this message is displayed indicating that the License has expired when connect to the detector or acquire an image

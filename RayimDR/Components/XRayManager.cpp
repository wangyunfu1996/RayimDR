...
XRayManager::XRayManager(QObject* parent) : QObject(parent)
{
    ...
    connect(this, &XRayManager::signalConnectToXRaySource, worker_, &XRayWorker::connectToXRaySource,
            Qt::QueuedConnection);
    connect(this, &XRayManager::signalDisconnectFromXRaySource, worker_, &XRayWorker::disconnectFromXRaySource,
            Qt::QueuedConnection);
    ...
    connect(this, &XRayManager::signalXRaySourceUpdateTargetTubeVoltage, worker_, &XRayWorker::updateTargetTubeVoltage,
            Qt::QueuedConnection);
    connect(this, &XRayManager::signalXRaySourceUpdateTargetTubeCurrent, worker_, &XRayWorker::updateTargetTubeCurrent,
            Qt::QueuedConnection);

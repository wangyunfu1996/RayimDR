...
XImageAdjustTool::XImageAdjustTool(QWidget* parent)
	: QWidget(parent)
{
	initUI();
	initConnect();
...
{
	connect(sliderW, &QSlider::valueChanged, this, [this](int value) {
		spinboxW->setValue(value);
		});

	connect(sliderL, &QSlider::valueChanged, this, [this](int value) {
		spinboxL->setValue(value);
		});

	connect(spinboxW, QOverload<int>::of(&QSpinBox::valueChanged), this, [this](int value) {
		sliderW->blockSignals(true);
	...
	connect(spinboxL, QOverload<int>::of(&QSpinBox::valueChanged), this, [this](int value) {
		sliderL->blockSignals(true);
	...
	connect(checkboxROI, &QCheckBox::toggled, this, [this](bool checked) {
	...
	connect(checkboxAutoWL, &QCheckBox::toggled, this, [this](bool checked) {
	...
	connect(sliderIdx, &QSlider::valueChanged, this, [this](int value) {
